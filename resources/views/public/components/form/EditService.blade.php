...
@section('content')
<h1 class="uk-heading-line uk-text-lead"><span>Update Service</span></h1>
@if(isset($message))
...
@endif
<form class="uk-form-stacked uk-grid-small" method="POST" action="{{ route('Service > Update', $service->hash) }}" uk-grid>
        @csrf
...
"prop":"value"
        ...
        <div class="uk-width-1-1" uk-grid>
            ...
            <div class="uk-width-1-1">
                <div class="uk-form-controls">
                    <button class="uk-button uk-button-primary">Update service</button>
                </div>
            </div>
        </div>
